...
t.goto(0, -100)
t.color("red")
t.write("Roses are red." , None, "center", ("Arial", 14, "bold"))
t.goto(1,-125)
t.write("Voilets are blue." , None, "center", ("Arial", 14, "bold"))
t.goto(2,-150)
t.write("I like coding." , None, "center", ("Arial", 14, "bold"))
t.goto(3,-175)
t.write("Do you to?" , None, "center", ("Arial", 14, "bold"))
t.color("white")
t.goto(0,-300)
turtle.done()